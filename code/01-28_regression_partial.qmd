...
ggplot(mod1_int_randeff, aes(sample = `(Intercept)`)) +
  stat_qq() +
  stat_qq_line()
...
ggplot(reg_dfw, aes(x = sr_ksha, y = yield_mgha)) +
  ...
  geom_line(
    data = nd,
    aes(x = sr_ksha, y = mod1_yield_mgha),
    color = "forestgreen"
  ) +
  geom_line(
    data = nd,
    aes(x = sr_ksha, y = mod2_yield_mgha),
    color = "blue"
  ) +
  geom_line(
    data = nd,
    aes(x = sr_ksha, y = mod3_yield_mgha),
    color = "orange"
  ) +
  geom_line(
    data = nd,
    aes(x = sr_ksha, y = mod4_yield_mgha),
    color = "red"
  )
